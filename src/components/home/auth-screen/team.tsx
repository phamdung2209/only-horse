    ...
    return (
        <section className="container py-24 sm:py-32">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 gap-y-10">
                {teamList.map(({ description, imageUrl, name, position }, idx) => (
                    <Card
                        key={idx}
                        className="bg-muted/50 relative mt-7 flex flex-col justify-center items-center"
                    >
                        <CardHeader className="my-6 flex justify-center items-center pb-2">
                            <Image
                                src={imageUrl}
                                alt={name}
                                width={150}
                        ...
                        <CardContent className="text-center pb-4 px-2">{description}</CardContent>
                    </Card>
                ))}
            </div>
        </section>
